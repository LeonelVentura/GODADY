...
<div class="page-content">
        ...
        echo "<center class='paginacion-wrapper'>
            <a class='paginacion' href='../administrador.php?pagina=1&evento=$id_evento'> << </a>";

        for($i = 1; $i <= $total_paginas; $i++) {
            echo "<a class='paginacion' href='../administrador.php?pagina=$i&evento=$id_evento'> $i </a>";
        }

        echo "<a class='paginacion' href='../administrador.php?pagina=$total_paginas&evento=$id_evento'> >> </a>
        </center>";
        ?>