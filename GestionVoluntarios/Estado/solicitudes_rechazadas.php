...
<div class="page-content">
            ...
            <div class="records table-responsive">
                <div class="record-header">
                    <div class="add">
                        ...
                        <input type="hidden" name="tab" value="<?= isset($_GET['tab']) ? htmlspecialchars($_GET['tab']) : 'Rechazadas' ?>">
        ...
        echo "<center class='paginacion-wrapper'>
            <a class='paginacion' href='../administrador.php?pagina=1&evento=$id_evento&tab=Rechazadas'> << </a>";

        for($i = 1; $i <= $total_paginas; $i++) {
            echo "<a class='paginacion' href='../administrador.php?pagina=$i&evento=$id_evento&tab=Rechazadas'> $i </a>";
        }

        echo "<a class='paginacion' href='../administrador.php?pagina=$total_paginas&evento=$id_evento&tab=Rechazadas'> >> </a>
        </center>";
        ?>